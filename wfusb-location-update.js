...
const program = 'MSBA';
const rows = [
  ['North Carolina', 25, 26, 29, 80, '34.0%', 'Lead location signal; prioritize alumni, employer history, and role searches here.'],
  ['New York', 3, 8, 6, 17, '7.2%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Ohio', 8, 6, 0, 14, '6.0%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['South Carolina', 2, 6, 6, 14, '6.0%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['California', 4, 6, 2, 12, '5.1%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Florida', 6, 4, 2, 12, '5.1%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Georgia', 5, 2, 4, 11, '4.7%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Texas', 5, 4, 1, 10, '4.3%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Washington, DC', 2, 6, 1, 9, '3.8%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Illinois', 1, 4, 2, 7, '3.0%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.']
];
const totals = { y2023: 83, y2024: 87, y2025: 65, total: 235 };
